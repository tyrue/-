...
class Game_Character
	...
	def update_event_execution?
		...
		return true if @starting or lock?
		return false
	end
	#--------------------------------------------------------------------------
	# * Update Movement
	...
	def update_movement
		...
		# Branch by move type
		move_type_random if @move_type == 1  # Random
		move_type_toward_player if @move_type == 2  # Approach
		move_type_custom if @move_type == 3  # Custom
	end
end
...
class Scene_Map
	...
	def update
		...
		update_scene unless $game_player.moving?
	end
	#--------------------------------------------------------------------------
	# * Update Systems
	#--------------------------------------------------------------------------
	...
	def update_call_debug
		# If debug mode is ON and F9 key was pressed; Set debug calling flag
...
class Scene_Menu
	...
	def commands_init
		...
		@commands.push(s1, s2, s3).flatten!
	end
	#--------------------------------------------------------------------------
	# * Main Processing
	#--------------------------------------------------------------------------
