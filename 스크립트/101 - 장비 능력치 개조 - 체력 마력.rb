...
class Set_Weapon_plus
	def initialize
		...
		# 중국무기
		@data[11] = [2000, 15000]    	# 대모홍접선
		@data[12] = [17000, 1000]    	# 구곡검
		@data[13] = [2000, 15000]    	# 영후단봉
		@data[14] = [17000, 1000]    	# 협가검
