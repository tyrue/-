...
class Set_Weapon_plus
	def initialize
		...
		# 중국무기
		@data[11] = [2000, 100000]    	# 대모홍접선
		@data[12] = [100000, 1000]    	# 구곡검
		@data[13] = [2000, 100000]    	# 영후단봉
		@data[14] = [100000, 1000]    	# 협가검
		
		@data[15] = [300, 300]    	# 석단장
		@data[16] = [1500, 1600]    	# 백사도
		@data[17] = [20000, 20000]    	# 음양도
		...
		# 용궁무기
		@data[115] = [30000, 30000]    # 심판의낫
		@data[117] = [3450, 3300]    	# 괴력선창
		@data[131] = [600, 700]    	# 다문창
		@data[132] = [1300, 1250]    	# 인어장군지팡이
		
		# 일본무기
		@data[134] = [2000, 50000]    	# 일화접선
		@data[135] = [50000, 2000]    	# 진일신검
		@data[136] = [2000, 2000]    	# 이가닌자의검
		@data[138] = [50000, 2000]    	# 청일기창
		
		# 용무기
		@data[142] = [200, 0]    	# 용마제사검
		@data[143] = [1000, 100]    	# 용마제칠검
		@data[144] = [25000, 250]    	# 용마제팔검
		@data[145] = [400000, 12500]    	# 용마제구검
		
		
		@data[147] = [0, 200]    	# 용랑제사봉
		@data[148] = [100, 1000]    	# 용랑제칠봉
		@data[149] = [500, 25000]    	# 용랑제팔봉
		@data[150] = [12500, 400000]    	# 용랑제구봉
		
		# 기타
		@data[123] = [4000, 4000]    	# 현무염도
		@data[124] = [350, 700]    	# 얼음검
		@data[127] = [2700, 2700]    	# 청룡신검
...
class Set_Armor_plus
	def initialize
		...
		@data[73] = [30000, 25000]		# 가릉빈가의날개옷'진
