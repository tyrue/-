...
if User_Edit::VISUAL_EQUIP_ACTIVE
	def equip_character(type, id)
		...
		if not $game_party.actors[0].hp == 0
			...
			return ['(착용)영혼마령봉', 2] 	if id == 107 	#불의영혼봉
			return ['(착용)목도', 2] 			if id == 108 	#백화검
			return ['(착용)목도', 2] 			if id == 109 	#이벤트백화검
			...
			return ['(착용)목도', 2] 			if id == 118  #철단도
			return ['(착용)목도', 2] 			if id == 119  #비철단도
			...
			return ['(착용)목도', 2] 			if id == 124  #얼음검
			return ['(착용)목도', 2] 			if id == 125  #일월대도
			return ['(착용)용마제팔검', 2]	if id == 126  #참마도
			return ['(착용)용마제팔검', 2] 	if id == 127  #청룡신검
			...
			return ['(착용)초록갑주', 2] 		if id == 12 	#주술갑옷
			return ['(착용)초록갑주', 2] 		if id == 13 	#남자타라의옷
			return ['(착용)초록갑주', 2] 		if id == 14 	#해골갑옷
			return ['(착용)가릉빈가의날개옷', 2] if id == 30 	#가릉빈가의날개옷
			return ['(착용)초록갑주', 2] 		if id == 31 	#초록색도포
			return ['(착용)초록갑주', 2] 		if id == 32 	#현인의영혼
