...
SKILL_POWER_CUSTOM[78] = [[1, 1.0 / 10.0, 0.01, 30]] # 십리건곤 1성
SKILL_POWER_CUSTOM[80] = [[1, 1.0 / 8.0, 0.01, 40]] # 십리건곤 2성
...
ABS_ENEMY_SKILL_CASTING[154] = [[1, "여의주의 힘을 받은 용이여..."], [1, "그대 이름은 청룡일지다..."], [1, "네 주인 이름으로 명하노니"], [1, "네 분노를 적에게 발산하라!"]] # 청룡마령참
ABS_ENEMY_SKILL_CASTING[158] = [[3, "불타버려라.."]] # 지옥겁화
ABS_ENEMY_SKILL_CASTING[159] = [[2, "하늘 높은 줄 모르고 겁도 없구나.."], [1, "신의 분노를 받아라!!"]] # 혈겁만파
ABS_ENEMY_SKILL_CASTING[160] = [[2, "너의 무력함을 깨달아라.."], [1, "압도적인 힘에 굴복해라!!"]] # 분혼경천
