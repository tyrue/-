...
ABS_ENEMY_SKILL_CASTING[154] = [[2, "여의주의 힘을 받은 용이여..."], [2, "그대 이름은 청룡일지다..."], [2, "네 주인 이름으로 명하노니"], [2, "네 분노를 적에게 발산하라!"]] # 청룡마령참
ABS_ENEMY_SKILL_CASTING[158] = [[3, "불타버려라.."]] # 지옥겁화
ABS_ENEMY_SKILL_CASTING[159] = [[4, "하늘 높은 줄 모르고 겁도 없구나.."], [2, "신의 분노를 받아라!!"]] # 혈겁만파
ABS_ENEMY_SKILL_CASTING[160] = [[2, "너의 무력함을 깨달아라.."], [2, "압도적인 힘에 굴복해라!!"]] # 분혼경천
