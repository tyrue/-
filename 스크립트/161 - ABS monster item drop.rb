class MrMo_ABS
	...
	ITEM_DROP_DATA[2] = [[-1], [0, 3, 10, 90], [2, 9, 1, 10]] # 다람쥐 : 도토리, 다람쥐화서
	...
	# 2차
	ITEM_DROP_DATA[58] = [[-1], [0, 90, 1, 90], [0, 52, 1, 2]] # 수룡 : 용의비늘, 수룡의비늘
	ITEM_DROP_DATA[59] = [[-1], [0, 90, 1, 90], [0, 53, 1, 2]] # 화룡 : 용의비늘, 화룡의비늘
	...
	ITEM_DROP_DATA[111] = [[2], [0, 70, 1, 60], [1, 125, 1, 20], [1, 129, 1, 15], [2, 44, 1, 10], [1, 130, 1, 10]] # 산적왕 : 빨간시약, 일월대도, 도깨비방망이, 황혼의활복, 산적왕의칼
	...
	# 극지방
	ITEM_DROP_DATA[105] = [[-1], [0, 103, 1, 30], [0, 116, 1, 40]] # 에메랄드인형 : 얼음, 황금호박
	ITEM_DROP_DATA[109] = [[-1], [0, 103, 1, 60]] # 눈괴물 : 얼음
	ITEM_DROP_DATA[110] = [[-1], [0, 103, 1, 60], [0, 101, 1, 10]] # 북극사슴 : 얼음, 단단한녹용
	...
	ITEM_DROP_DATA[132] = [[1], [0, 123, 1, 70], [0, 122, 1, 40]] # 건룡 : 건룡의어금니, 은나무가지
	ITEM_DROP_DATA[133] = [[1], [0, 124, 1, 70], [0, 122, 1, 40]] # 감룡 : 감룡의어금니, 은나무가지
	ITEM_DROP_DATA[134] = [[1], [0, 125, 1, 70], [0, 122, 1, 40]] # 진룡 : 진룡의어금니, 은나무가지
	...
	ITEM_DROP_DATA[189] = [[-1], [0, 162, 1, 70]] # 주마관 : 희귀진호박
	...
	ITEM_DROP_DATA[195] = [[-1], [0, 157, 1, 3]] # 이가닌자병 : 검조각 
	ITEM_DROP_DATA[196] = [[-1], [0, 159, 1, 3]] # 이가닌자수 : 수리검
	ITEM_DROP_DATA[197] = [[-1], [0, 160, 1, 3]] # 이가닌자마 : 이가닌자의 독
	ITEM_DROP_DATA[198] = [[-1], [0, 158, 1, 3]] # 이가닌자영 : 흑룡철심
	ITEM_DROP_DATA[199] = [[-1], [0, 156, 1, 3]] # 이가닌자화 : 이가닌자의 보패
