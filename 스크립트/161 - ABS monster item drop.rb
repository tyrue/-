class MrMo_ABS
	...
	ITEM_DROP_DATA[99] = [[1], [0, 60, 1, 60], [0, 201, 1, 30], [0, 202, 1, 30], [0, 203, 1, 30], [0, 204, 1, 30]] # 귀웅 : 쇠조각, 대지의토템, 바람의토템, 번개의토템, 화염의토템
	...
	ITEM_DROP_DATA[246] = [[2], [0, 209, 1, 60], [0, 211, 1, 60], [0, 201, 1, 40], [0, 202, 1, 40], [0, 203, 1, 40], [0, 204, 1, 40], [0, 213, 1, 10]] # 선장망령 : 기름자루, 향료가루, 대지의토템, 바람의토템, 번개의토템, 화염의토템, 정령의결정
end
