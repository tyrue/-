class MrMo_ABS
	...
	ITEM_DROP_DATA[99] = [[1], [0, 60, 1, 60], [0, 201, 1, 30], [0, 202, 1, 10], [0, 203, 1, 10], [0, 204, 1, 10]] # 귀웅 : 쇠조각, 대지의토템, 바람의토템, 번개의토템, 화염의토템
	...
	ITEM_DROP_DATA[249] = [[2], [0, 201, 1, 10], [0, 202, 1, 10], [0, 203, 1, 30], [0, 204, 1, 10], [0, 214, 1, 40]] # 야월진랑 : 대지의토템, 바람의토템, 번개의토템, 화염의토템, 독니
