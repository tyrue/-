class MrMo_ABS
	...
	ITEM_DROP_DATA = {}
	# 초보사냥터
	ITEM_DROP_DATA[1] = [[-1], [0, 74, 1, 80], [2, 10, 1, 5]] # 토끼 : 토끼고기, 토끼화서
	ITEM_DROP_DATA[2] = [[-1], [0, 3, 5, 70], [2, 9, 1, 5]] # 다람쥐 : 도토리, 다람쥐화서
	...
	ITEM_DROP_DATA[125] = [[-1], [0, 112, 1, 1]] # 양왕 : 리괘
	ITEM_DROP_DATA[126] = [[-1], [0, 107, 1, 30]] # 돼지왕 : 진괘
	ITEM_DROP_DATA[127] = [[-1], [0, 108, 1, 1]] # 말왕 : 선괘
	...
	# 도삭산
	ITEM_DROP_DATA[232] = [[2], [0, 194, 3, 100], [0, 195, 1, 30], [3, 1000000, 1, 0.1], [1, 112, 1, 10]] # 산신대왕 : 산신의바늘, 산신의천, 돈, 양첨목봉
	...
	ITEM_DROP_DATA[259] = [[2], [0, 220, 2, 100], [0, 98, 1, 3]] # 가릉빈가 : 가릉빈가의 날개, 삿갓머리 화서
