class MrMo_ABS
	...
	ITEM_DROP_DATA[99] = [[2], [0, 60, 1, 30], [0, 201, 1, 40], [0, 202, 1, 10], [0, 203, 1, 10], [0, 204, 1, 10]] # 귀웅 : 쇠조각, 대지의토템, 바람의토템, 번개의토템, 화염의토템
	...
	ITEM_DROP_DATA[246] = [[3], [0, 209, 1, 60], [0, 211, 1, 60], [0, 201, 1, 10], [0, 202, 1, 40], [0, 203, 1, 10], [0, 204, 1, 10], [0, 213, 1, 30]] # 선장망령 : 기름자루, 향료가루, 대지의토템, 바람의토템, 번개의토템, 화염의토템, 정령의결정
	...
	ITEM_DROP_DATA[252] = [[3], [0, 201, 1, 10], [0, 202, 1, 10], [0, 203, 1, 10], [0, 204, 1, 60], [0, 206, 1, 10], [0, 207, 1, 10]] # 마려 : 대지의토템, 바람의토템, 번개의토템, 화염의토템, 자연의인'상, 자연의인'하
end
