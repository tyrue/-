class MrMo_ABS
	...
	ITEM_DROP_DATA[111] = [[4], [0, 70, 5, 100], [1, 125, 1, 30], [1, 129, 1, 15], [2, 44, 1, 5], [1, 130, 1, 2], [0, 116, 1, 15]] # 산적왕 : 빨간시약, 일월대도, 도깨비방망이, 황혼의활복, 뇌령진도, 황금호박
	...
	# 극지방
	ITEM_DROP_DATA[105] = [[-1], [0, 103, 30, 80], [0, 116, 1, 30], [0, 58, 1, 15]] # 에메랄드인형 : 얼음, 황금호박, 청녹용
	...
	ITEM_DROP_DATA[193] = [[-1], [2, 55, 1, 2], [0, 154, 1, 100], [0, 37, 3, 30]] # 파괴왕 : 망또4, 순수의강철, 참나무조각
