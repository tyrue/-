class MrMo_ABS
	...
	# 돼지굴
	ITEM_DROP_DATA[21] = [[-1], [0, 19, 1, 50], [0, 28, 1, 10]] # 산돼지 : 산돼지고기, 돼지의뿔
	ITEM_DROP_DATA[22] = [[-1], [0, 20, 1, 50], [0, 28, 1, 10]] # 숲돼지 : 숲돼지고기, 돼지의뿔
	ITEM_DROP_DATA[77] = [[-1], [0, 59, 1, 70], [1, 23, 1, 30]] # 청산숲돼지: 청산돼지뿔, 철도
	
	# 사슴굴
	ITEM_DROP_DATA[23] = [[-1], [0, 5, 3, 80]] # 주홍사슴 : 사슴고기
	ITEM_DROP_DATA[25] = [[-1], [0, 6, 5, 80], [1, 22, 1, 3]] # 흑/백순록 : 녹용, 비철단도
	ITEM_DROP_DATA[76] = [[2], [0, 6, 50, 60], [0, 29, 1, 40], [1, 22, 1, 20]] # 청순록 : 녹용, 호박, 비철단도
	...
	# 일본세작
	ITEM_DROP_DATA[100] = [[1], [0, 29, 1, 60], [0, 30, 1, 60]] # 일본세작 : 호박, 진호박
	...
	ITEM_DROP_DATA[110] = [[-1], [0, 103, 2, 40], [0, 101, 2, 10], [0, 58, 1, 3]] # 북극사슴 : 얼음, 단단한녹용, 청녹용
	...
	ITEM_DROP_DATA[154] = [[-1], [0, 145, 1, 2], [0, 140, 1, 15]] # 외칼상어 : 상어의핵, 상어의심장
	ITEM_DROP_DATA[155] = [[-1], [0, 145, 1, 2], [0, 140, 1, 15]] # 쌍칼상어 : 상어의핵, 상어의심장
	...
	ITEM_DROP_DATA[190] = [[-1], [0, 153, 1, 4]] # 망령 : 도깨비가죽
	...
	ITEM_DROP_DATA[205] = [[-1], [0, 170, 1, 20]] # 청염유 : 청색구슬조각
	ITEM_DROP_DATA[206] = [[-1], [0, 168, 1, 20]] # 자염유 : 자색구슬조각 
