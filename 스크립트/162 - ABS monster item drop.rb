class MrMo_ABS
	...
	ITEM_DROP_DATA[193] = [[-1], [2, 55, 1, 2], [0, 154, 1, 35], [0, 37, 3, 100]] # 파괴왕 : 망또4, 순수의강철, 참나무조각
	...
	# 폭염도 화산굴
	ITEM_DROP_DATA[250] = [[-1], [0, 162, 1, 1], [0, 215, 1, 3]] # 철보장 : 희귀진호박, 금조각
	ITEM_DROP_DATA[251] = [[-1], [0, 162, 1, 1], [0, 216, 1, 3]] # 철거인 : 희귀진호박, 반짝이는돌
