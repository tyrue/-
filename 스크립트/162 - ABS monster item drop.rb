class MrMo_ABS
	...
	ITEM_DROP_DATA[111] = [[4], [0, 70, 5, 70], [1, 125, 1, 30], [1, 129, 1, 15], [2, 44, 1, 5], [1, 130, 1, 5], [0, 116, 1, 15]] # 산적왕 : 빨간시약, 일월대도, 도깨비방망이, 황혼의활복, 뇌령진도, 황금호박
	...
	ITEM_DROP_DATA[109] = [[-1], [0, 103, 3, 30]] # 눈괴물 : 얼음
	ITEM_DROP_DATA[110] = [[-1], [0, 103, 1, 50], [0, 101, 2, 10], [0, 58, 1, 2]] # 북극사슴 : 얼음, 단단한녹용, 청녹용
	...
	ITEM_DROP_DATA[193] = [[-1], [2, 55, 1, 1], [0, 154, 1, 100], [0, 37, 3, 30]] # 파괴왕 : 망또4, 순수의강철, 참나무조각
	...
	# 도삭산
	ITEM_DROP_DATA[232] = [[-1], [2, 56, 1, 1], [0, 194, 3, 100], [0, 195, 1, 50], [3, 1000000, 1, 0.1], [1, 112, 1, 10]] # 산신대왕 : 망또5, 산신의바늘, 산신의천, 돈, 양첨목봉
