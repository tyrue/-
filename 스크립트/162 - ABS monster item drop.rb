class MrMo_ABS
	...
	ITEM_DROP_DATA[76] = [[-1], [0, 101, 6, 60], [0, 29, 1, 10], [1, 22, 1, 30]] # 청순록 : 단단한 녹용, 호박, 비철단도
	...
	ITEM_DROP_DATA[66] = [[-1], [0, 29, 3, 80], [0, 30, 3, 80], [0, 116, 1, 3]] # 인형술사 : 호박, 진호박, 황금호박
	...
	ITEM_DROP_DATA[36] = [[-1], [0, 29, 4, 80], [0, 30, 4, 80], [0, 37, 2, 50], [0, 116, 1, 10]] # 처녀귀신 : 호박, 진호박, 불의결정, 황금호박
	...
	ITEM_DROP_DATA[80] = [[1], [2, 33, 1, 15], [1, 129, 1, 30]] # 청명도깨비 : 도깨비부적, 도깨비방망이
	...
	ITEM_DROP_DATA[82] = [[-1], [0, 60, 2, 60], [1, 118, 1, 15]] # 구미호 : 쇠조각, 철단도
	ITEM_DROP_DATA[83] = [[-1], [0, 61, 2, 60], [1, 118, 1, 15]] # 불구미호 : 수정의조각, 철단도
