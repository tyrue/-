class MrMo_ABS
	...
	ITEM_DROP_DATA[36] = [[-1], [0, 116, 1, 10]] # 처녀귀신 : 황금호박
	...
	ITEM_DROP_DATA[111] = [[3], [0, 70, 5, 60], [1, 125, 1, 30], [1, 129, 1, 15], [2, 44, 1, 5], [1, 130, 1, 5]] # 산적왕 : 빨간시약, 일월대도, 도깨비방망이, 황혼의활복, 산적왕의칼
	...
	ITEM_DROP_DATA[101] = [[-1], [0, 116, 1, 10]] # 일본세작대장 : 황금호박
	...
	# 극지방
	ITEM_DROP_DATA[105] = [[-1], [0, 103, 10, 30], [0, 116, 1, 40]] # 에메랄드인형 : 얼음, 황금호박
	ITEM_DROP_DATA[109] = [[-1], [0, 103, 3, 40]] # 눈괴물 : 얼음
	ITEM_DROP_DATA[110] = [[2], [0, 103, 3, 40], [0, 101, 1, 20], [0, 58, 1, 1]] # 북극사슴 : 얼음, 단단한녹용, 청녹용
	...
	ITEM_DROP_DATA[119] = [[2],  [0, 120, 1, 30], [0, 121, 1, 30], [0, 106, 1, 30]] # 백호왕 : 크리스탈, 수정, 건괘
	...
	ITEM_DROP_DATA[125] = [[-1], [0, 112, 1, 1], [0, 161, 1, 1]] # 양왕 : 리괘, 희귀호박
	ITEM_DROP_DATA[126] = [[-1], [0, 107, 1, 30]] # 돼지왕 : 진괘
	ITEM_DROP_DATA[127] = [[-1], [0, 108, 1, 1], [0, 161, 1, 1]] # 말왕 : 선괘, 희귀호박
	ITEM_DROP_DATA[128] = [[-1], [0, 109, 1, 30]] # 원숭이왕 : 태괘
	ITEM_DROP_DATA[129] = [[-1], [0, 113, 1, 1]] # 개왕 : 간괘
