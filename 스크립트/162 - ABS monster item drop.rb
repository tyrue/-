class MrMo_ABS
	...
	ITEM_DROP_DATA[159] = [[3], [0, 161, 1, 60], [0, 162, 1, 60], [0, 120, 1, 30], [0, 121, 1, 30], [1, 112, 1, 40]] # 거북장군 : 희귀호박, 희귀진호박, 수정, 크리스탈, 양첨목봉
	...
	# 도삭산
	ITEM_DROP_DATA[232] = [[-1], [0, 194, 3, 100], [0, 195, 1, 30], [3, 1000000, 1, 0.1], [1, 112, 1, 10]] # 산신대왕 : 산신의바늘, 산신의천, 돈, 양첨목봉
	...
	ITEM_DROP_DATA[252] = [[4], [0, 201, 1, 10], [0, 202, 1, 10], [0, 203, 1, 10], [0, 204, 1, 60], [0, 206, 1, 15], [0, 207, 1, 15]] # 마려 : 대지의토템, 바람의토템, 번개의토템, 화염의토템, 자연의인'상, 자연의인'하
