...
class ABS_enemy_spec
	...
	def initialize
		...
		@enemy[241] = [1, 88, 88, true, [0], 1, 3, 3, [0], 600] # 인면벌
		@enemy[242] = [1, 88, 88, true, [0], 0.8, 3, 4, [0], 3000] # 문비
		
		@enemy[243] = [1, 88, 88, true, [0], 1, 3, 4, [0], 1200] # 최가
		@enemy[244] = [1, 88, 88, true, [0], 1, 3, 4, [0], 1200] # 백보
		@enemy[245] = [1, 88, 88, true, [0], 0.8, 3, 4, [0], 1500] # 엽춘
		@enemy[246] = [1, 88, 88, true, [0], 0.7, 3, 4, [0], 6000] # 선장망령
		
		@enemy[247] = [1, 88, 88, true, [0], 0.7, 3, 4, [0], 1200] # 사마귀
		@enemy[248] = [1, 88, 88, true, [0], 0.7, 4, 3, [0], 1500] # 독화
		@enemy[249] = [1, 88, 88, true, [0], 0.7, 4, 4, [0], 6000] # 야월진랑
		
		@enemy[250] = [1, 88, 88, true, [0], 0.8, 4, 4, [0], 6000] # 철보장
		@enemy[251] = [1, 88, 88, true, [0], 0.8, 4, 4, [0], 6000] # 철거인
		@enemy[252] = [1, 88, 88, true, [0], 0.7, 4, 4, [0], 10000] # 마려
		
		# 파티퀘스트
		@enemy[253] = [1, 88, 88, true, [254, 255, 256, 257, 258], 1, 3, 4, [1, 1153], 0] # 현무
		@enemy[254] = [1, 88, 88, true, [0, 253], 1, 3, 4, [0], 100000] # 뇌랑
		@enemy[255] = [1, 88, 88, true, [0, 253], 1, 3, 4, [0], 100000] # 왕가
		@enemy[256] = [1, 88, 88, true, [0, 253], 1, 3, 4, [0], 100000] # 조왕
		@enemy[257] = [1, 88, 88, true, [0, 253], 1, 4, 4, [1, 1158], 100000] # 태산
		@enemy[258] = [1, 88, 88, true, [0, 253], 1, 4, 4, [1, 1157], 100000] # 길림장군
