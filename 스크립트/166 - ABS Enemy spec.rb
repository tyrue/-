...
class ABS_enemy_spec
	...
	def initialize
		...
		# 이벤트
		@enemy[49] = [6, 7, 7, false, [0], 1, 3, 3, [0], 300] # 고래
		
			
		# 여우굴
		@enemy[54] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1000] # 불여우
		@enemy[82] = [1, 20, 20, true, [0], 1, 3, 4, [0], 3000] # 구미호
		@enemy[83] = [1, 20, 20, true, [0], 1, 3, 4, [0], 3000] # 불구미호
		
		# 2차 퀘
		@enemy[58] = [1, 20, 20, true, [0], 1, 5, 3, [0], 5000] # 수룡
		@enemy[59] = [1, 20, 20, true, [0], 1, 5, 3, [0], 5000] # 화룡
		@enemy[86] = [1, 20, 20, true, [0], 1, 3, 3, [0], 800] # 용
		...
		@enemy[229] = [1, 9, 9, true, [0], 0.8, 3, 3, [0], 800] # 연청천구
		@enemy[230] = [1, 9, 9, true, [0], 0.8, 3, 3, [0], 800] # 연자천구
		@enemy[231] = [1, 22, 22, true, [0], 0.6, 3, 5, [0], 10000] # 천구왕
	end
	def spec(id)
		return @enemy[id]
	end
