...
class ABS_enemy_spec
	...
	def initialize
		...
		@enemy[215] = [1, 15, 15, true, [0], 0.8, 5, 5, [0], 6000] # 악어왕
		...
		@enemy[220] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1200] # 산소괴왕
		
		@enemy[221] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1200] # 청괴성
		@enemy[222] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1200] # 자괴성
		@enemy[223] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1200] # 동괴성
		@enemy[224] = [1, 9, 9, true, [0], 1, 3, 3, [0], 1200] # 괴성왕
