class Bitmap
	...
	alias jingukang_jindow_draw_text draw_text
	def draw_text(
			x = 0, y = (x.rect? ? '' : 0),
			width = (x.rect? ? 0 : 1),
			height = (x.rect? ? 0 : 1),
		...
		case font.alpha
		when 0
			jingukang_jindow_draw_text(x, y, width, height, str, align)
		when 1
			c = font.color.dup
			font.color.set(font.gamma.red, font.gamma.green, font.gamma.blue,
				font.gamma.alpha / 4)
		...
		when 3
			...
			font.color = font.gamma
			jingukang_jindow_draw_text(x, y, width, height, str, align)
			jingukang_jindow_draw_text(x + font.beta, y, width, height, str, align)
			jingukang_jindow_draw_text(x + font.beta * 2, y, width, height, str, align)
			jingukang_jindow_draw_text(x, y + font.beta, width, height, str, align)
