...
class Jindow_Status < Jindow
	def initialize
		...
		@exp_s = $game_party.actors[0].exp.to_s
		...
		@attack_s = $game_party.actors[0].base_atk.to_s
		...
		@defense_s = $game_party.actors[0].base_pdef.to_s
		...
		@magic_defense_s = $game_party.actors[0].base_mdef.to_s
		...
		@eva_s = $game_party.actors[0].base_eva.to_s
	...
	def update
		...
		if @exp_s != $game_party.actors[0].exp.to_s
			@exp.dispose
			@exp = Sprite.new(self)
			@exp.bitmap = Bitmap.new(100, 20)
			@exp.x = 70
		...
		if @gold_s != $game_party.gold.to_s
			@gold.dispose
			@gold = Sprite.new(self)
			@gold.bitmap = Bitmap.new(180, 20)
			@gold.x = 90
		...
		if @attack_s != $game_party.actors[0].base_atk.to_s
			@attack.dispose
			@attack = Sprite.new(self)
			@attack.bitmap = Bitmap.new(130, 30)
			@attack.x = 177
		...
		if @defense_s != $game_party.actors[0].base_pdef.to_s
			@defense.dispose
			@defense = Sprite.new(self)
			@defense.bitmap = Bitmap.new(130, 30)
			@defense.x = 177
		...
		if @magic_defense_s != $game_party.actors[0].base_mdef.to_s
			@magic_defense.dispose
			@magic_defense = Sprite.new(self)
			@magic_defense.bitmap = Bitmap.new(130, 30)
			@magic_defense.x = 177
			@magic_defense.y = 120
		...
		if @eva_s != $game_party.actors[0].base_eva.to_s
			@eva.dispose
			@eva = Sprite.new(self)
			@eva.bitmap = Bitmap.new(130, 30)
			@eva.x = 168
