...
class Jindow_hairct < Jindow
	...
	def initialize
		...
		@buttons = []
		#선택지 
		@a = J::Button.new(self).refresh(80, "1000전")
		@b = J::Button.new(self).refresh(80, "닫기")
		@c = J::Button.new(self).refresh(80, "1000전")
		@d = J::Button.new(self).refresh(80, "1000전")
		@e = J::Button.new(self).refresh(80, "6000전")
		@a.y = 85
		@b.x = 170
		@b.y = 380
		@c.x = 105
	...
	def update
		...
		if @a.click   #  1번머리(기본 설정머리)
			...
			$game_system.se_play($data_system.decision_se)
			if $game_variables[165] > 6000
				$game_party.lose_gold(6000)
				Hwnd.dispose(self)
