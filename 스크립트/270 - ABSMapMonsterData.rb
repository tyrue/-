...
MAP_MONSTER_DATA = {}
# 부여성
MAP_MONSTER_DATA[44] = [[45, 15]] # 흑해골굴1 : 황해골
MAP_MONSTER_DATA[45] = [[45, 15]] # 흑해골굴2 : 황해골

MAP_MONSTER_DATA[453] = [[46, 15], [47, 15]] # 인형굴1 : 목각인형, 양철인형
MAP_MONSTER_DATA[454] = [[46, 15], [47, 15], [48, 1]] # 인형굴1 : 목각인형, 양철인형, 인형술사

# 2차 승급 
MAP_MONSTER_DATA[72] = [[44, 22]] # 수룡의방 : 용
MAP_MONSTER_DATA[73] = [[44, 22]] # 화룡의방 : 용
...
MAP_MONSTER_DATA[93] = [[21, 7], [22, 7], [23, 7], [24, 7], [25, 1], [26, 1], [27, 1], [28, 1], [29, 1]] # 네고개7 : 힘의뱀, 민첩의뱀, 지력의뱀, 손재주의뱀, 주사, 력사, 민사, 지사, 재사
